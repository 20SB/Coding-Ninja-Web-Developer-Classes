...
public class kReverse {
    ...
    public static DoubleNode reverseRBetter(LinkedListNode<Integer> head) {
        DoubleNode ans;
	...
	public static LinkedListNode<Integer> kReverse(LinkedListNode<Integer> head, int k) {
        ...
        if(k==0) return head;
            ...
            return head;
             ...
             LinkedListNode<Integer> preservedHead = temp.next;
             temp.next = null;
             DoubleNode ans = reverseRBetter(head);
             LinkedListNode<Integer> revHead = kReverse(preservedHead, k);
             ans.tail.next = revHead;
             head = ans.head;
             return head;
        }
	}
