...
public class Merge_Sort_LL {
	public static LinkedListNode<Integer> calculateMid(LinkedListNode<Integer> head) {
	...
	public static LinkedListNode<Integer> mergeSort(LinkedListNode<Integer> head) {
        ...
        if(head== null || head.next == null) return head;
            ...
            LinkedListNode<Integer> mid = calculateMid(head);
            LinkedListNode<Integer> p1 = head;
            LinkedListNode<Integer> p2 = mid.next;
            mid.next = null;

            LinkedListNode<Integer> h1 = mergeSort(p1);
            LinkedListNode<Integer> h2 = mergeSort(p2);
            LinkedListNode<Integer> res = merge(h1, h2);
            return res;
        }
